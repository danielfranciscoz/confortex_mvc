...
namespace Confortex.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (new ConfortexEntities().Usuario.Where(w => w.UserName == model.User && w.regAnulado == false).ToList().Count > 0)
            {
                ...
                ModelState.AddModelError("", "No se encuentra el usuario en el sistema.");
                return View(model);
            }
